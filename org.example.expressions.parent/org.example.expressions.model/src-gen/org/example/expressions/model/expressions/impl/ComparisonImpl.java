 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.ComparisonImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.ComparisonImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.ComparisonImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComparisonImpl extends ExpressionImpl implements Comparison {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.COMPARISON__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.COMPARISON__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.COMPARISON__LEFT, newLeft,
					newLeft));
	}
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.COMPARISON__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.COMPARISON__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.COMPARISON__RIGHT, newRight,
					newRight));
	}
