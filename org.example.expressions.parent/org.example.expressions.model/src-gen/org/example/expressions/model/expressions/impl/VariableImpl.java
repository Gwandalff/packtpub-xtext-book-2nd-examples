 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.VariableImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends AbstractElementImpl implements Variable {
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.VARIABLE__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.VARIABLE__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.VARIABLE__EXPRESSION,
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == VarOrParam.class) {
			...
			case ExpressionsPackage.VARIABLE__NAME:
				return ExpressionsPackage.VAR_OR_PARAM__NAME;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == VarOrParam.class) {
			...
			case ExpressionsPackage.VAR_OR_PARAM__NAME:
				return ExpressionsPackage.VARIABLE__NAME;
			default:
				return -1;
			}
		}
