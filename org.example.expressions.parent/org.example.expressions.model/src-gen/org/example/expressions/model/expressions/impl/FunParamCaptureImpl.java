 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.FunParamCaptureImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunParamCaptureImpl extends FunParamImpl implements FunParamCapture {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExpressionsPackage.FUN_PARAM_CAPTURE__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.FUN_PARAM_CAPTURE__VARIABLE,
