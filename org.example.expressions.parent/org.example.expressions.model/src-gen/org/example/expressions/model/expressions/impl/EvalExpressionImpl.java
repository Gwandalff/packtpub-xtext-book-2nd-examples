 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.EvalExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.EVAL_EXPRESSION__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EVAL_EXPRESSION__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EVAL_EXPRESSION__EXPRESSION,
