 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.MulOrDivImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.MulOrDivImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.MulOrDivImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MulOrDivImpl extends ExpressionImpl implements MulOrDiv {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.MUL_OR_DIV__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.MUL_OR_DIV__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.MUL_OR_DIV__LEFT, newLeft,
					newLeft));
	}
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.MUL_OR_DIV__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.MUL_OR_DIV__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.MUL_OR_DIV__RIGHT, newRight,
					newRight));
	}
