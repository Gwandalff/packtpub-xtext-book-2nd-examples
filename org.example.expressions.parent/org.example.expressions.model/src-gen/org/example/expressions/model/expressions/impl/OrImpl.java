 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.OrImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.OrImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrImpl extends ExpressionImpl implements Or {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.OR__LEFT,
					oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.OR__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		right = newRight;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.OR__RIGHT,
					oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.OR__RIGHT, null, msgs);
			if (newRight != null)
