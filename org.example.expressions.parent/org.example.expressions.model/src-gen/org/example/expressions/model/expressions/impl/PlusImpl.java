 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.PlusImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.PlusImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlusImpl extends ExpressionImpl implements Plus {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.PLUS__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.PLUS__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.PLUS__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.PLUS__RIGHT, null, msgs);
			if (newRight != null)
