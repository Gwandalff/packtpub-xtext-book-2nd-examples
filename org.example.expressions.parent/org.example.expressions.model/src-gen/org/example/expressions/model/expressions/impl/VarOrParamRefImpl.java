 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.VarOrParamRefImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarOrParamRefImpl extends ExpressionImpl implements VarOrParamRef {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExpressionsPackage.VAR_OR_PARAM_REF__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(VarOrParam newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.VAR_OR_PARAM_REF__VARIABLE,
