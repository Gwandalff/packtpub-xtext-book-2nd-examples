 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.ComplexFunctionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetBody(Block newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.COMPLEX_FUNCTION__BODY, oldBody, newBody);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject) body).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.COMPLEX_FUNCTION__BODY, null, msgs);
			if (newBody != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.COMPLEX_FUNCTION__BODY, newBody,
					newBody));
	}
