 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.BlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetStatements(Statements newStatements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.BLOCK__STATEMENTS, oldStatements, newStatements);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStatements != statements) {
			...
			if (statements != null)
				msgs = ((InternalEObject) statements).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.BLOCK__STATEMENTS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BLOCK__STATEMENTS, newStatements,
					newStatements));
	}
