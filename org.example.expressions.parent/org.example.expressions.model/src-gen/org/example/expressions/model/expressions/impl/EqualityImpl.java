 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.EqualityImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.EqualityImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.EqualityImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityImpl extends ExpressionImpl implements Equality {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.EQUALITY__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.EQUALITY__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY__RIGHT, newRight,
					newRight));
	}
