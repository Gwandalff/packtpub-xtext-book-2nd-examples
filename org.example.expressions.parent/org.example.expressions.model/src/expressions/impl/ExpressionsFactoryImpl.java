...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExpressionsPackage.STATEMENTS: return createStatements();
			case ExpressionsPackage.ABSTRACT_ELEMENT: return createAbstractElement();
			case ExpressionsPackage.LOOP: return createLoop();
			case ExpressionsPackage.CONDITION: return createCondition();
			case ExpressionsPackage.BLOCK: return createBlock();
			case ExpressionsPackage.FUN_DEFINITION: return createFunDefinition();
			case ExpressionsPackage.INLINE_FUNCTION: return createInlineFunction();
			case ExpressionsPackage.COMPLEX_FUNCTION: return createComplexFunction();
			case ExpressionsPackage.VAR_OR_PARAM: return createVarOrParam();
			...
			case ExpressionsPackage.FUN_PARAM: return createFunParam();
			case ExpressionsPackage.FUN_CALL: return createFunCall();
			...
			case ExpressionsPackage.VAR_OR_PARAM_REF: return createVarOrParamRef();
			case ExpressionsPackage.FUN_PARAM_EXP: return createFunParamExp();
			case ExpressionsPackage.FUN_PARAM_CAPTURE: return createFunParamCapture();
			case ExpressionsPackage.CONTEXT: return createContext();
			case ExpressionsPackage.STRING_TO_VALUE_BINDING_MAP: return (EObject)createStringToValueBindingMap();
			case ExpressionsPackage.INT_VALUE: return createIntValue();
			case ExpressionsPackage.BOOL_VALUE: return createBoolValue();
