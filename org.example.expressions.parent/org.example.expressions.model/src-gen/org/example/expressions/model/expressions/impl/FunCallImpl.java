 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.FunCallImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link org.example.expressions.model.expressions.impl.FunCallImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunCallImpl extends ExpressionImpl implements FunCall {
		...
		if (function != null && function.eIsProxy()) {
			...
			if (function != oldFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.FUN_CALL__FUNCTION,
	...
	public void setFunction(FunDefinition newFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.FUN_CALL__FUNCTION, oldFunction,
					function));
	}
