...
public class ExpressionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExpressionsPackage.LOOP: {
			...
			if (result == null)
				result = caseAbstractElement(loop);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionsPackage.CONDITION: {
			...
			if (result == null)
				result = caseAbstractElement(condition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExpressionsPackage.FUN_DEFINITION: {
			...
			if (result == null)
				result = caseAbstractElement(funDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionsPackage.INLINE_FUNCTION: {
			...
			if (result == null)
				result = caseAbstractElement(inlineFunction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionsPackage.COMPLEX_FUNCTION: {
			...
			if (result == null)
				result = caseAbstractElement(complexFunction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExpressionsPackage.PARAMETER: {
			...
			if (result == null)
				result = caseVarOrParam(parameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionsPackage.VARIABLE: {
			...
			if (result == null)
				result = caseAbstractElement(variable);
			if (result == null)
				result = caseVarOrParam(variable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionsPackage.EVAL_EXPRESSION: {
			...
			if (result == null)
				result = caseAbstractElement(evalExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExpressionsPackage.MUL_OR_DIV: {
			...
			if (result == null)
				result = caseExpression(mulOrDiv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExpressionsPackage.VAR_OR_PARAM_REF: {
			...
			if (result == null)
				result = caseExpression(varOrParamRef);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExpressionsPackage.STRING_TO_EOBJECT_BINDING_MAP: {
			...
			Map.Entry<String, EObject> stringToEObjectBindingMap = (Map.Entry<String, EObject>) theEObject;
			T result = caseStringToEObjectBindingMap(stringToEObjectBindingMap);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>String To EObject Binding Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>String To EObject Binding Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStringToEObjectBindingMap(Map.Entry<String, EObject> object) {
		return null;
	}
