 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expressions.model.expressions.impl.FunParamExpImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.FUN_PARAM_EXP__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.FUN_PARAM_EXP__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.FUN_PARAM_EXP__EXPR, newExpr,
					newExpr));
	}
